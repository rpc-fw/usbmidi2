...
/*
** ===================================================================
**     Event       :  MIDIUART2_OnError (module Events)
**
**     Component   :  MIDIUART2 [AsynchroSerial]
**     Description :
**         This event is called when a channel error (not the error
**         returned by a given method) occurs. The errors can be read
**         using <GetError> method.
...
** ===================================================================
*/
void MIDIUART2_OnError(void);

/*
** ===================================================================
**     Event       :  MIDIUART2_OnRxChar (module Events)
**
**     Component   :  MIDIUART2 [AsynchroSerial]
**     Description :
**         This event is called after a correct character is received.
...
** ===================================================================
*/
void MIDIUART2_OnRxChar(void);

/*
** ===================================================================
**     Event       :  MIDIUART2_OnTxChar (module Events)
**
**     Component   :  MIDIUART2 [AsynchroSerial]
**     Description :
**         This event is called after a character is transmitted.
...
** ===================================================================
*/
void MIDIUART2_OnTxChar(void);

/*
** ===================================================================
**     Event       :  MIDIUART2_OnFullRxBuf (module Events)
**
**     Component   :  MIDIUART2 [AsynchroSerial]
**     Description :
**         This event is called when the input buffer is full;
...
** ===================================================================
*/
void MIDIUART2_OnFullRxBuf(void);

/*
** ===================================================================
**     Event       :  MIDIUART2_OnFreeTxBuf (module Events)
**
**     Component   :  MIDIUART2 [AsynchroSerial]
**     Description :
**         This event is called after the last character in output
...
** ===================================================================
*/
void MIDIUART2_OnFreeTxBuf(void);
